namespace Remember {
    export async function rendezvous(): ƒS.SceneReturn {
        ...
        await ƒS.update(0.2);
        await ƒS.Speech.tell(characters.Soldier, "Are you armed? Sorry, but we have to confiscate everything that could be used as a weapon.");
        ...
        await ƒS.Speech.tell(characters.Soldier, "I've been around long enough to notice the small things. Your stance and body language, the look \
